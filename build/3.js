...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AmHomePageModule", function() { return AmHomePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__am_home__ = __webpack_require__(656);
...
var AmHomePageModule = /** @class */ (function () {
    function AmHomePageModule() {
    }
    AmHomePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__am_home__["a" /* AmHomePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__am_home__["a" /* AmHomePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */]
            ],
        })
    ], AmHomePageModule);
    return AmHomePageModule;
}());

//# sourceMappingURL=am-home.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AmHomePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_firestore_firestore__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(36);
...
/**
 * Generated class for the AmHomePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var AmHomePage = /** @class */ (function () {
    function AmHomePage(navCtrl, navParams, mdlCtrl, firestore) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        ...
        this.sps$ = this.firestore.getSPs();
        this.cust$ = this.firestore.getCustomers();
        this.coord$ = this.firestore.getCoords();
        this.selectedTab = "profile";
    }
    AmHomePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AmHomePage');
    };
    AmHomePage.prototype.selectTab = function (tab) {
        this.selectedTab = tab;
    };
    AmHomePage.prototype.addSP = function () {
        var a = this.mdlCtrl.create(__WEBPACK_IMPORTED_MODULE_3__dyna_dyna__["a" /* DynaPage */]);
        a.present();
        // a.onDidDismiss()
    };
    AmHomePage.prototype.addCust = function () {
    };
    AmHomePage.prototype.addCoords = function () {
    };
    AmHomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
            selector: 'page-am-home',template:/*ion-inline-start:"C:\src\seva\src\pages\am-home\am-home.html"*/'<!--\n  Generated template for the AmHomePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <header title="AM Home"></header>\n</ion-header>\n\n<ion-content padding>\n  <ion-toolbar>\n    <ion-segment [(ngModel)]="selectedTab">\n      <ion-segment-button value="profile" (tap)="selectTab(\'profile\')">\n        <ion-label>Profile</ion-label>\n      </ion-segment-button>\n      <ion-segment-button value="sp" checked (tap)="selectTab(\'sp\')">\n        <ion-label>Service</ion-label>\n      </ion-segment-button>\n      <ion-segment-button value="cust" (tap)="selectTab(\'cust\')">\n        <ion-label>Customers</ion-label>\n      </ion-segment-button>\n      <ion-segment-button value="co-ord" (tap)="selectTab(\'co-ord\')">\n        <ion-label>coordinators</ion-label>\n      </ion-segment-button>\n    </ion-segment>\n  </ion-toolbar>\n  <profile *ngIf="selectedTab == \'profile\'"></profile>\n  <div *ngIf="selectedTab == \'sp\'">\n    <!-- <button ion-button float-right (click)="addSP()">Add New</button> -->\n    <user-list [userList]="(sps$ | async)"></user-list>\n  </div>\n  <div *ngIf="selectedTab == \'cust\'">\n    <!-- <button ion-button float-right (click)="addCust()">Add New</button> -->\n    <user-list [userList]="(cust$ | async)"></user-list>\n  </div>\n  <div *ngIf="selectedTab == \'co-ord\'">\n    <!-- <button ion-button float-right (click)="addCoords()">Add New</button> -->\n    <user-list [userList]="(coord$ | async)"></user-list>\n  </div>\n</ion-content>'/*ion-inline-end:"C:\src\seva\src\pages\am-home\am-home.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["j" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["k" /* NavParams */],
...
//# sourceMappingURL=am-home.js.map
